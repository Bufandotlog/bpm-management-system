        ...
        if (!$error) {
            try {
                if ($action_type === 'update' && $is_edit) {
                    ...
                    redirect('admin/surat/arsip-surat.php?jenis='.$jenis_surat, 'Perubahan arsip berhasil disimpan!', 'success');
                } else {
                    dbQuery(
                    ...
                    redirect('admin/surat/arsip-surat.php?jenis='.$jenis_surat, 'Arsip manual berhasil dicatat!', 'success');
                }
                exit();
            } catch (Exception $e) {
