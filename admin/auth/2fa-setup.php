...
<?php if ($step === 2): ?>
    <div style="text-align:center;padding:40px 20px;">
        ...
        <a href="<?php echo baseUrl('admin/core/dashboard.php'); ?>" style="display:inline-block;padding:12px 30px;background:#4A90E2;color:white;border-radius:8px;text-decoration:none;font-weight:600;">Ke Dashboard</a>
    </div>
<?php else: ?>
    <?php if ($totpEnabled): ?>
