    ...
    if (($_POST['confirm'] ?? '') === 'yes') {
        if ($struktur && !empty($struktur['gambar'])) {
            if (deleteFile($struktur['gambar'])) {
                ...
                redirect('admin/konten/upload-struktur.php', 'Gambar struktur organisasi berhasil dihapus!', 'success');
            } else {
                redirect('admin/konten/upload-struktur.php', 'Gagal menghapus file gambar.', 'error');
            }
        } else {
            redirect('admin/konten/upload-struktur.php', 'Tidak ada gambar yang dihapus.', 'info');
        }
    } else {
        redirect('admin/konten/upload-struktur.php', 'Penghapusan dibatalkan', 'info');
    }
    exit();
}
?>
