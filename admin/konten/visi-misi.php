...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!csrfVerify()) {
        redirect('admin/konten/visi-misi.php', 'Request tidak valid.', 'error');
        exit();
    }
    ...
    if (empty($visi)) {
        redirect('admin/konten/visi-misi.php', 'Visi tidak boleh kosong.', 'error');
        exit();
    }
    if (empty($misi)) {
        redirect('admin/konten/visi-misi.php', 'Minimal satu misi harus diisi.', 'error');
        exit();
    }
    ...
    redirect('admin/konten/visi-misi.php', 'Visi misi berhasil diperbarui!', 'success');
    exit();
}
...
<link rel="stylesheet" href="<?php echo baseUrl('admin/css/visi-misi.css'); ?>">
