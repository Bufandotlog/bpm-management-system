...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!csrfVerify()) {
        redirect('admin/konten/kontak.php', 'Request tidak valid.', 'error');
        exit();
    }
    ...
    if (empty($error)) {
        ...
        redirect('admin/konten/kontak.php', 'Data kontak berhasil diperbarui!', 'success');
        exit();
    }
}
...
<link rel="stylesheet" href="<?php echo baseUrl('admin/css/kontak.css'); ?>">
