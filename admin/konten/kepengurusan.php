...
<div class="page-header">
    ...
    <div style="margin-top: 10px; padding: 8px 15px; background: rgba(74,144,226,0.1); border-radius: 5px; display: inline-block;">
        ...
        <?php if ($user_can_access_all): ?>
            <a href="<?php echo baseUrl('admin/system/ganti-periode.php'); ?>" style="margin-left: 15px; color: var(--primary); text-decoration: none;">
...
<link rel="stylesheet" href="<?php echo baseUrl('admin/css/kepengurusan.css'); ?>">
