...
if (!$data) {
    redirect('admin/konten/kepengurusan.php', 'Data tidak ditemukan atau bukan milik periode ini!', 'error');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm'])) {
    ...
    if (!csrfVerify()) {
        redirect('admin/konten/kepengurusan.php', 'Request tidak valid.', 'error');
        exit();
    }
    ...
    if ($_POST['confirm'] === 'yes') {
        ...
        try {
            ...
            if ($hapus) {
                ...
                redirect('admin/konten/kepengurusan.php', $judul[$posisi] . ' berhasil dihapus', 'success');
            } else {
            ...
            redirect('admin/konten/kepengurusan.php', 'Gagal menghapus data.', 'error');
        }
    } else {
        redirect('admin/konten/kepengurusan.php', 'Penghapusan dibatalkan', 'info');
    }
    exit();
}
...
<link rel="stylesheet" href="<?php echo baseUrl('admin/css/kepengurusan-hapus.css'); ?>">
