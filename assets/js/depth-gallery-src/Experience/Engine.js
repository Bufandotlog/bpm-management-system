...
class Engine {
  constructor(canvas, experience = world) {
    ...
    // Scroll
    this.viewport = canvas.closest('[data-depth-gallery-viewport]')
    this.scope = canvas.closest('[data-depth-gallery]')
    this.scroll = new Scroll(this.camera, this.experience.gallery, this.debug, this.scope)
